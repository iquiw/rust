...
URL=https://cdn.netbsd.org/pub/NetBSD/NetBSD-7.1.2

# Originally from ftp://ftp.netbsd.org/pub/NetBSD/NetBSD-$BSD/source/sets/*.tgz
curl $URL/source/sets/src.tgz | tar xzf -
curl $URL/source/sets/gnusrc.tgz | tar xzf -
curl $URL/source/sets/sharesrc.tgz | tar xzf -
curl $URL/source/sets/syssrc.tgz | tar xzf -
...
hide_output ./build.sh -j10 -m i386 tools
